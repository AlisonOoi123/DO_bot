...
# INTENTIONALLY EMPTY — lorry assignment is driven entirely by capacity/weight
# fit and utilisation scoring.  The engine picks the tightest-fitting available
# lorry for each group; outstation routes enforce OUTSTATION_MIN_TON (>5T only).
#
# The ONLY hard plate-level restrictions are in LORRY_STRICT_ROUTE below
# (lorries physically stationed at a specific depot or contractually bound).
